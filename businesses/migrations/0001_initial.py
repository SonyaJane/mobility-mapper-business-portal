...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tier', models.CharField(choices=[('free', 'Free'), ('standard', 'Standard'), ('premium', 'Premium')], default='free', help_text='Tier type (free, supporter, featured)', max_length=20)),
                ...
                ('stripe_monthly_price_id', models.CharField(help_text='The Stripe Price ID for this tier', max_length=100)),
                ('stripe_annual_price_id', models.CharField(blank=True, help_text='The Stripe Price ID for yearly billing', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_frequency', models.CharField(choices=[('monthly', 'Monthly'), ('yearly', 'Yearly (Save up to 20%)')], default='monthly', help_text='Billing frequency for this business (monthly or yearly)', max_length=10)),
                ...
                ('pricing_tier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='businesses', to='businesses.pricingtier')),
            ],
            options={
